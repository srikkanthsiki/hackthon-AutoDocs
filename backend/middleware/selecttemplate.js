...
function  upsertdataandgeneratereport(req,tpath, dataObj) {
  ...
  */
  ...
  function  mapTemplate(req, res, next) {
   ...
   req.templatemap = getTemplatefromMap(req,req.templatesList)
...
s3.upload (uploadParams, function (err, data) {
  ...
  function checkforcompletions3(req, res, next){
      
      if(1==1){
          next()
      }else{
          console.log("wait for few sec")
          setTimeout(checkforcompletions3(req, res, next), 2000);
           next()
      }
  }
  
    function checkforcompletionec2(req, res, next){
                console.log("checkforcompletionec2")
  ...
  module.exports = {
    ...
    checkforcompletions3:checkforcompletions3,
    checkforcompletionec2:checkforcompletionec2
  }